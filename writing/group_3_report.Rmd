...
=======
>>>>>>> 993593326eb1b8be2537f5b30a7fb8414ee046a0

Use this tab to identify covid-19 outbreaks in Larimer County. An active outbreak is defined as two or more cases within a facility or a workplace. The identification of outbreaks and the subsequent contact tracing is an important measure in limiting the spread of covid-19 in our communities. 
...
The plot shows  outbreaks among Larimer county businesses by each month. It is a static graph and does not change when a different industry is selected in the sidebar. 
